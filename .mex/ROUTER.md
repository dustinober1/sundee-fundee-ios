...
**Working:**
- Apple Sign-In authentication with Keychain session persistence
- Guest mode with LocalDataClient (full offline functionality)
- CloudKit persistence for signed-in users via DataClientProtocol
...
- Admin dashboard beyond basic Teenybase content management
- Full analytics/charting implementation (empty state exists)
- Comprehensive UI test suite (simulator automation has known gotchas)
...
| Working with persistence, CloudKit, offline sync | `context/data-layer.md` |
