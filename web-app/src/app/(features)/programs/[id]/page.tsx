...
import { exerciseValueToString } from "@/lib/domain";
  ...
  return (
    <div className="flex flex-col gap-8 pt-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <StatCard value={program.difficulty.charAt(0).toUpperCase() + program.difficulty.slice(1)} label={program.difficulty} />
      </div>
