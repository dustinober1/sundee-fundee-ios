...
Plans:
- [x] 09-01-PLAN.md — Flutter project scaffold + dependencies + Drift web assets
- [x] 09-02-PLAN.md — Core app shell: Drift database, GoRouter, placeholder screens, offline banner
- [x] 09-03-PLAN.md — Parity gate test suite: navigation, onboarding, workout, offline tests
- [x] 09-04-PLAN.md — Android SDK + CocoaPods toolchain installation (gap closure)
- [x] 09-05-PLAN.md — Drift persistence wiring + offline test fix (gap closure)
