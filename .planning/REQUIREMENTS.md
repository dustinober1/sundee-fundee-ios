# Requirements for Sundee-Fundee
...
- **PROG-04**: Add custom program creation by users
- **UI-02**: Add social sharing of achievements

## Out of Scope
- Social networking or community features — not needed for initial training focus
- Deep HealthKit/Google Fit integration — manual cycle entry suffices for v1

## Traceability
_To be filled by roadmap when phases are created._
