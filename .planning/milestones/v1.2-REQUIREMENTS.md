...
**Status:** Archived (shipped 2026-02-25; QA-01 carried forward to v1.3)
**Milestone:** v1.2
...
- [ ] **QA-01**: User-facing access paths for Home, Programs, and Workout are covered by automated tests validating authenticated read/write behavior. *(Carried forward — CI run confirmation pending)*
